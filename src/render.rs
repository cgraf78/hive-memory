...
//!
//! Rendered adapter files are disposable views over canonical memory. This
//! module owns the generated-file marker and checksum rules so every adapter
//! refuses drift the same way before overwriting a file.
...
///
/// Doctor uses this instead of open-coding marker parsing so render and
/// diagnostics agree on the generated-file checksum contract.
